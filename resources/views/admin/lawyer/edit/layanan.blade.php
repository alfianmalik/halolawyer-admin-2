<div class="container">
    <div class="row pt-5">
        <div class="col-md-8 offset-md-1">
            <h5 class="text-black font-weight-bold">Pengalaman Perkara</h5>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Nama Bank</label>
                <div class="col-sm-9">
                    <input type="password" id="password" class="form-control" id="basic-url" name="password" aria-describedby="basic-addon3">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Nama Penerima</label>
                <div class="col-sm-9">
                    <input type="password" id="password" class="form-control" id="basic-url" name="password" aria-describedby="basic-addon3">
                </div>
            </div>
