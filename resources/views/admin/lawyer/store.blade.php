...
<div class="mb-4">
    <ul class="nav nav-tabs" id="nav-tab">
        ...
        <li class="nav-item" >
            <a class="nav-link" data-toggle="tab" href="#b" role="tab" aria-controls="home" aria-selected="true">
                <span class="badge badge-primary p-2 ">2</span>
                Profesi
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#c" role="tab" aria-controls="home" aria-selected="true">
                <span class="badge badge-primary p-2 ">3</span>
                Pemilihan Wilayah Kerja
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#d" role="tab" aria-controls="home" aria-selected="true">
                <span class="badge badge-primary p-2 ">4</span>
                Pendidikan &
                Spesialisasi</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#e" role="tab" aria-controls="home" aria-selected="true">
                <span class="badge badge-primary p-2 ">5</span>
                Pengalaman
                Perkara</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#f" role="tab" aria-controls="home" aria-selected="true">
