    ...
    <div class="row pt-5">
        <div class="col-md-8 offset-md-1">
            ...
            <div class="form-group row mt-5">
                <label for="office_name" class="col-sm-3 col-form-label">Nama Kantor</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="alanat" class="col-sm-3 col-form-label">Detail Alamat</label>
                <div class="col-sm-9">                  
            ...
            <div class="form-group row">
                <label for="office_phone" class="col-sm-3 col-form-label">No Telepon Kantor</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="no_izin_advokat" class="col-sm-3 col-form-label">No Izin Advokat / Kartu Anggota</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="long_work_experience" class="col-sm-3 col-form-label">Lama Pengalaman Kerja </label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="advokat_year" class="col-sm-3 col-form-label">Tahun Penyumpahan Advokat</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="dokumen" class="col-sm-3 col-form-label">Dokumen Terkait
                    <br>
                ...
                <div class="col-sm-9">
                    <button type="button" class="btn btn-outline-primary">Add Upload File</button>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="prabono" class="col-sm-3 col-form-label">Kasus Probono</label>
                <div class="col-sm-9">
                    <!-- Rounded switch -->
                    <label class="switch">
                        <input type="checkbox">
